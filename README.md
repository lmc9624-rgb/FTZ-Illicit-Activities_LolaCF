...
const zones = [
  {name:"Colon Free Zone",lat:9.35,lon:-79.9,region:"carib",color:"#1D9E75",r:5.5,
    desc:"World's 2nd-largest FTZ (after Hong Kong). 2,500+ companies, ~$19B annual turnover. FinCEN (2010 advisory): flagged shipments through here as BMPE red flags. TRACIT (2025): profiled as key illicit trade corridor. Long used by Colombian & Mexican cartels for trade-based money laundering.",
    lx:10,ly:-10,anchor:"start"},

  {name:"Margarita Island FTZ",lat:11.0,lon:-63.9,region:"carib",color:"#1D9E75",r:4.5,
    desc:"Venezuelan duty-free island. U.S. Congressional testimony (2011–2013): Hezbollah operated training camps & smuggling networks here under Chávez/Maduro. Former Treasury official (Oct 2025 Senate testimony) called it 'a center of gravity' for Hezbollah. DOJ (May 2020): alleged Venezuelan officials recruited Hezbollah/Hamas for clandestine camps. 10,400+ Venezuelan passports issued to Lebanese/Syrian/Iranian nationals (2010–2019). Note: Maduro arrested by U.S. forces Jan 2026 — current status of networks uncertain.",
    lx:8,ly:-8,anchor:"start"},

  {name:"Curacao FTZ",lat:12.17,lon:-68.98,region:"carib",color:"#1D9E75",r:4,
    desc:"Dutch Caribbean free zone. In April 2009, 250 law enforcement officials arrested 17 suspects in an alleged Hezbollah-linked drug ring shipping 2,000+ kg cocaine/year to Europe & Middle East. Authorities said proceeds were funneled via informal banking. Note: Jamestown Foundation (2009) questioned the strength of the Hezbollah link specifically.",
    lx:-8,ly:-10,anchor:"end"},

  {name:"Trinidad & Tobago",lat:10.5,lon:-61.3,region:"carib",color:"#1D9E75",r:3.5,
    desc:"Point Lisas free zone. 7 miles from Venezuela. State of emergency declared Jan 2025 over record narco-violence (61 homicides in Dec 2024 alone). Cocaine enters via small boats from Venezuela. 132 known coastal disembarkation points (Min. of National Security, 2022). U.S. State Dept: key transshipment location for cocaine to US/UK/Europe.",
    lx:8,ly:12,anchor:"start"},

  {name:"Kingston FTZ",lat:17.97,lon:-76.79,region:"carib",color:"#1D9E75",r:4,
    desc:"Jamaica's main FTZ. 150+ unofficial coastal entry points (Jamaica PM, Sept 2023). 1,500kg cocaine seized at Kingston Freeport Terminal (Jan 2023, ~$80M — Jamaica Constabulary Force). 538kg disguised as Cuban honey seized March 2025. Key corridor on Cartagena-to-US/UK cocaine route.",
    lx:-8,ly:-8,anchor:"end"},

  {name:"Manaus Free Zone",lat:-3.12,lon:-60.02,region:"latam",color:"#D85A30",r:4.5,
    desc:"Brazil's largest FTZ, at the confluence of the Solimões & Negro rivers. UNODC (2023): cocaine from Colombia/Peru arrives via river, is loaded onto cargo ships at Manaus heading to Africa & Europe. Over 900 drug routes transit the Amazon Basin. INTERPOL established Amazon-focused task force based here (Feb 2026). Brazilian govt (Nov 2025): criminal gangs (Red Command, PCC) now operate in 45% of Amazon municipalities.",
    lx:8,ly:-8,anchor:"start"},

  {name:"Tri-Border Area",lat:-25.5,lon:-54.6,region:"latam",color:"#D85A30",r:5.5,
    desc:"Argentina-Brazil-Paraguay junction. Active since the 1980s. FinCEN (Oct 2024 alert): Hezbollah generates revenue here through money laundering, narcotics trafficking, charcoal/oil smuggling, counterfeiting & illicit diamond trade. U.S. State Dept Rewards for Justice (May 2025): $10M reward for info on Hezbollah financial networks in the TBA. Assad Barakat network sanctioned by U.S. Treasury (2004, with subsequent designations).",
    lx:8,ly:4,anchor:"start"},

  {name:"Iquique FTZ",lat:-20.21,lon:-70.15,region:"latam",color:"#D85A30",r:4,
    desc:"Chile's largest FTZ (ZOFRI). 1,700+ businesses, 30,000 jobs, trading with 70+ countries. U.S. State Dept INCSR (2015): flagged Chile's FTZs as 'largely unregulated' for AML — status may have since improved. Major counterfeiting pipeline for Chinese goods to Bolivia/Paraguay (TRACIT, 2025). FBI-prompted takedown of 'Clan Cheng' ($200M fraud) in Jan 2026. Chilean prosecutors investigating Lebanese-linked firms for Hezbollah money laundering (2024).",
    lx:-8,ly:4,anchor:"end"},

  {name:"Buenaventura",lat:3.88,lon:-77.02,region:"latam",color:"#D85A30",r:4.5,
    desc:"Colombia's Pacific port. DOJ (2025): Clan del Golfo's primary income is cocaine trafficking — controlled deliveries of 191kg & 172kg made in Cartagena/Valledupar (2018). Key transit for cocaine to Central America & Mexico. Crisis Group (March 2025): identified Buenaventura as one of Latin America's worst-hit drug trafficking hotspots with extreme urban violence.",
    lx:-8,ly:4,anchor:"end"},

  {name:"Cartagena FTZ",lat:10.39,lon:-75.51,region:"latam",color:"#D85A30",r:4,
    desc:"Colombia's Caribbean port zone. ICE (2013 case): traffickers used parasitic devices on cargo ship hulls at Cartagena, with insider access to port scheduling data. Crisis Group (2025): established Cartagena-to-Miami cocaine corridor. FinCEN (2010): Black Market Peso Exchange & trade-based money laundering node. DEA agent Irizarry corruption case (exposed 2020, sentenced 2023) showed deep penetration of port logistics.",
    lx:-8,ly:4,anchor:"end"},

  {name:"Lome Free Zone",lat:6.13,lon:1.22,region:"wafrica",color:"#534AB7",r:4.5,
    desc:"Togo's port zone. On the Lagos–Cotonou–Lomé–Accra trafficking corridor (~500km, UNODC). FATF (2016): Gulf of Guinea & Sahel trafficking routes are 'so heavily used' they finance terrorist groups including Boko Haram & AQIM. U.S. Treasury (2011, Lebanese Canadian Bank case): identified Togo-Ghana border in a Hezbollah-linked drug/cash laundering route — products moved across borders to Accra airport, cash shipped via MEA to Lebanon. Lomé airport flagged by UNODC for cocaine couriers to Europe.",
    lx:-8,ly:-10,anchor:"end"},

  {name:"Lagos Free Zone",lat:6.45,lon:3.39,region:"wafrica",color:"#534AB7",r:5,
    desc:"Nigeria's commercial hub. UNODC: Lagos airport is a major transit point for cocaine couriers. GI-TOC (2025, non-govt): est. up to 30% of Europe's cocaine transits West Africa. FATF (2016): Boko Haram finances through extortion, ransom, cattle rustling & trade; ISWAP (ISIS affiliate, 3,500–5,000 fighters — UN Security Council, 2020 listing) exploits cash economy via kidnapping & illegal levies. Nigerian FIU (reported 2024): detected ISIS-linked crypto transfers to two Nigerians ($19,900 & $9,900). U.S. Treasury (2011): Hezbollah used-car/cash laundering through West African networks.",
    lx:8,ly:12,anchor:"start"},

  {name:"Dakar FTZ",lat:14.69,lon:-17.44,region:"wafrica",color:"#534AB7",r:4.5,
    desc:"Senegal's port zone. GI-TOC (Sept 2025, non-govt): Port of Dakar called West Africa's 'most strategic hub' for cocaine exports to Spain/Europe. Balkan organized crime groups (Kavač, Škaljari clans) increasingly active since ~2019. On 'Highway 10' — the shortest transatlantic route from Brazil (~2,500km). FATF (2016): Sahel & Gulf of Guinea trafficking routes used to finance Boko Haram & AQIM. GIABA (West African AML body) headquartered in Dakar. ~30,000 Lebanese residents. HSI provided TBML training to Senegalese law enforcement (INCSR 2025).",
    lx:8,ly:-10,anchor:"start"},

  {name:"Abidjan FTZ",lat:5.36,lon:-4.01,region:"wafrica",color:"#534AB7",r:4.5,
    desc:"Ivory Coast. Est. 60,000–300,000 Lebanese residents (largest Lebanese diaspora in West Africa). U.S. Treasury designations & FinCEN reports: Hezbollah fundraising networks active in diaspora communities since the 1980s. 1.2 tonnes of cocaine destined for Abidjan seized at Santos port, Brazil (Sept 2018). UNODC (2024): Abidjan is now a destination market, not just transit, with growing local user communities.",
    lx:-8,ly:12,anchor:"end"},

  {name:"Accra FTZ",lat:5.56,lon:-0.19,region:"wafrica",color:"#534AB7",r:3.5,
    desc:"Ghana's free zone. U.S. Treasury (2011, Lebanese Canadian Bank case): Accra airport identified as endpoint in Hezbollah-linked used-car/cash laundering scheme — drugs transported across Togo-Ghana border, cash flown to Lebanon. Ghana govt survey (2021): cocaine is most-abused drug in Greater Accra. UNODC: Ghana is a significant synthetic drug producer & cocaine transit zone to UK. Host of Dec 2025 'Accra Call to Action' drug summit.",
    lx:8,ly:-4,anchor:"start"},

  {name:"Port of Montreal",lat:45.5,lon:-73.56,region:"north",color:"#378ADD",r:5,
    desc:"Canada. Canadian govt (Sept 2025 risk report): Port of Montreal is a 'known link where luxury vehicles are shipped to Lebanon, financially supporting Hezbollah.' Operation Vector (April 2024): 598 stolen vehicles worth $34.5M seized (OPP/CBSA). In 2023, 1,200 stolen vehicles recovered at the port. DEA (Jan 2008 briefing to RCMP): identified Hezbollah operatives in Montreal via wiretap evidence from Colombian narco-kingpins.",
    lx:8,ly:-10,anchor:"start"},

  {name:"Halifax Port",lat:44.65,lon:-63.57,region:"north",color:"#378ADD",r:4,
    desc:"Canada. CBSA (March 2024): 1,556kg cocaine seized, valued at $194M, from a container en route from California to Europe via Panama Canal. DEA (Jan 2008 briefing to RCMP): identified Halifax as part of Hezbollah 'leadership cells for Western Hemisphere operations.' Canadian Sept 2025 risk assessment confirmed Hezbollah's continued use of both licit and illicit channels in Canada.",
    lx:8,ly:6,anchor:"start"},

  {name:"Miami FTZ",lat:25.76,lon:-80.19,region:"north",color:"#378ADD",r:4.5,
    desc:"US gateway to Latin America & Caribbean. FinCEN: primary hub for the Black Market Peso Exchange — 'one of the most extensive money laundering methodologies' in the Western Hemisphere. FinCEN Advisory (2010): flagged shipments of electronics, auto parts & precious metals from Miami to FTZs as TBML red flags. DOJ (2005, Operation Mallorca): $50M+ in drug proceeds laundered through BMPE via Miami bank accounts. BMPE remains active per recent INCSR reports.",
    lx:8,ly:-10,anchor:"start"},

  {name:"Rotterdam Port",lat:51.92,lon:4.48,region:"north",color:"#378ADD",r:4,
    desc:"Europe's largest port. EU member states reported a record 356 tonnes of cocaine seized in 2022, with Belgium, Spain & the Netherlands reporting highest volumes. Europol: key entry point for Latin American cocaine. Crisis Group (2025): established trafficking corridor from Buenaventura & Cartagena. Europol-led 'super cartel' arrests (2022–2023) linked to Rotterdam trafficking operations.",
    lx:8,ly:-8,anchor:"start"},

  {name:"Port of Beirut",lat:33.9,lon:35.5,region:"mideast",color:"#D4537E",r:5,
    desc:"Lebanon. Hezbollah's home base. FinCEN (Oct 2024 alert): Hezbollah generates ~$1B annually from Iranian support, international businesses, donor networks, corruption & money laundering. U.S. Treasury: destination for stolen vehicles from Canada, laundered funds & trade flows from Latin America, West Africa & the Caribbean. Multiple OFAC designations (ongoing) target Hezbollah financiers based in Lebanon.",
    lx:8,ly:-10,anchor:"start"},

  {name:"Dubai / Jebel Ali",lat:25.0,lon:55.1,region:"mideast",color:"#D4537E",r:4.5,
    desc:"UAE free zone. FATF (2020 report, using 2017–2018 data): JAFZA accounts for 32% of UAE foreign investment & 24% of Dubai's GDP ($118B trade value in 2017) — yet only 99 financial intelligence requests from free zones over 5 years (2014–2018). U.S. State Dept INCSR: UAE listed as 'major money laundering country.' OFAC designated Jebel Ali entities for Iran/Russia sanctions evasion — Bitubiz (2024), Hennesea (2024). U.S. Treasury (March 2022): sanctioned six individuals after UAE court convicted them for transferring $782,000 from Dubai to Boko Haram. Europol: European 'super cartel' leaders arrested here (2019–2023). UAE removed from FATF grey list Feb 2024.",
    lx:8,ly:6,anchor:"start"},
];
